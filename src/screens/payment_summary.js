...
function Payment_summary({route}) {
  const { totalPrice, order_id } = route.params || { totalPrice: 0 };
  return (
    <View>
      <Appbar />
      <View>
      <View style = {{height: '59%'}}>
        ...
        <View style={styles.oorder}>
          ...
          <View style={styles.order}>
            <Text style={styles.text2}>SAR {totalPrice.toFixed(2)}</Text>
          </View>
        </View>
        ...
        <View style={styles.oorder}>
          ...
          <View style={styles.order}>
            <Text style={styles.text3}>- SAR 0.00</Text>
          </View>
        </View>
        ...
        <View style={styles.oorder}>
          ...
          <View style={styles.order}>
            <Text style={styles.text2}>SAR 0.00</Text>
          </View>
        </View>
        ...
        <View style={styles.oorder}>
          ...
          <View style={styles.order}>
            <Text style={styles.text4}>SAR {totalPrice.toFixed(2)}</Text>
          </View>
        </View>
      </View>
